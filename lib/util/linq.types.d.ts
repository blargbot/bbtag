...
export interface IEnumerable<T> extends Iterable<T> {
    ...
    elementAtOr<R = T>(index: number, value: R): T | R;
    first(predicate?: S<T, boolean>): T;
    firstOr<R = T>(value: R): T | R;
    firstOr<R = T>(predicate: S<T, boolean>, value: R): T | R;
    ...
    lastOr<R = T>(value: R): T | R;
    lastOr<R = T>(predicate: S<T, boolean>, value: R): T | R;
    ...
    singleOr<R = T>(value: R): T | R;
    singleOr<R = T>(predicate: S<T, boolean>, value: R): T | R;
